      ...
      <div className='container mx-auto max-w-4xl rounded-2xl bg-white px-6 py-8 shadow-sm'>
        ...
        <div className='mt-6 space-y-4 text-base leading-8 text-[#4b5563]'>
          <p>
            ...
            شراء بسيطة وسريعة لعملائنا.
          </p>
          <p>
            نهدف إلى جعل تجربة اختيار العطر تجربة مميزة، من خلال عرض مجموعة متنوعة من الروائح التي تناسب مختلف الأذواق، سواء العطور
            الفاخرة أو العطور اليومية.
          </p>
          <p>نسعى دائماً إلى تقديم أفضل الأسعار وخدمة عملاء موثوقة عبر متجرنا الإلكتروني.</p>
        </div>
      </div>
    </div>
  );
