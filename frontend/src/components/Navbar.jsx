      ...
      <header className='fixed inset-x-0 top-0 z-50 bg-white shadow-sm'>
        <div className='mx-auto flex h-20 max-w-6xl items-center justify-between px-4'>
          ...
          <Link to='/' className='flex flex-col items-center gap-1 text-center' onClick={closeMenu}>
            <span className='text-sm font-semibold tracking-[0.18em] text-brand-primary'>الصاحب</span>
            <span className='text-xs font-medium tracking-[0.4em] text-[#111111]'>موطن العطور الأصلية</span>
          </Link>
